<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpStudy\WWW\yiqiu\public/../application/index\view\depot\jiancang.html";i:1510054692;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<blockquote style="margin:0;" class="layui-elem-quote mylog-info-tit">
    <div class="layui-inline">
        <form class="layui-form" id="resSearchForm" method="" action="">
            ...
            <input type="hidden" name="depot_type" value="1">
        </form>
    </div>
</blockquote>
<!-- 菜单列表 -->
<div style="padding:0;" id="data-list" class="layui-tab-item layui-show" style="padding: 10px 15px;">
...
<script type="text/javascript">
    ...
    layui.config({
        ...
        table.render({
            elem: '#resTableList',
            url: '/index/Depot/jiancangInfo?depot_type=1',
            id:'resTableId',
            method: 'post',
            height:'525px',
            skin:'row',
            ...
            size: 'sm',
            cols: [[
                {field:'goods_name', title: '商品',width: 100,style:'color:#EE3B3B' },
                ...
                {field:'nickname', title: '老师名称',width: 100,style:'color:#01AAED'},
        ...
        table.on('tool(resTableId)', function(obj) {
            ...
            if(layEvent === 'pingcang'){
                location.href='/index/Depot/pingcang_add?id='+data.did+'&goods_name='+data.goods_name;
            }
...
<script type="text/html" id="handle">
    ...
    {{#  } }}
    {{#  if('<?php echo $pj; ?>'){ }}
    <a lay-event="pingcang" class="layui-btn layui-btn-danger layui-btn-mini" >平仓</a>
    {{#  } }}
</script>
<script>
