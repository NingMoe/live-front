<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\WWW\yiqiu\public/../application/index\view\user\m-register.html";i:1514358474;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="login-title">
    ...
    <a href="/index/User/login" class="login-reg">登录</a>
    用户登录
</div>
<div class="login-content">
    <ul class="login-from">
        ...
        <li>
            <i class="icon3"></i>
            <input style="width: 4.8rem;" type="num" name="phone" class="telInput" placeholder="请输入手机号">
            <span class="getma">获取验证码</span>
        </li>
        <li>
            <i class="icon4"></i>
            <input type="text" name="ma" class="maInput" placeholder="填写验证码">
        </li>
        <li class="ma" id="login-yzm" style="">
